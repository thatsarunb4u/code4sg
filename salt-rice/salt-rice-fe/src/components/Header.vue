	...
	<header>
		...
		<nav v-if="isLoggedIn">
			<div class="icon-login">
				<a @click="showEditProfile = !showEditProfile" href="#" class="hide-desktop">
					<img
			...
			<ul v-bind:class="showMenu ? '' : 'show-desktop'" id="nav">
				<li @click="showMenu = !showMenu" id="exit" class="exit-btn hide-desktop">
				...
				<li>
					<router-link to="/post" exact active-class="bold">Create post</router-link>
				</li>
				<li>
					<a @click="showEditProfile = !showEditProfile" id="editprofile" class="hide-mobile"
		...
		<nav v-if="!isLoggedIn">
			<div style="cursor:pointer">
				<a class="cte bold" href="/login">Login</a>
			</div>
		</nav>
		<div
		...
		>
			<div class="head">
				...
				<a href="#">
					<img src="@/assets/images/edit.png" alt="toogle icon-pen" class="icon-pen" id="icon-pen-picture" />
				</a>
			</div>
